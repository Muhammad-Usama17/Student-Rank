let deg1 = [71, 103, 86, 77, 84, 81, 92, 75, 86, 105, 90, 77, 86, 50, 94, 81, 96, 27, 75, 89, 96, 92, 102, 70, 91, 89, 85, 104, 66, 81, 79, 106, 95, 87, 88, 83, 107, 92, 76, 89, 99, 69, 80, 93, 102, 106, 86, 97, 79, 71, 75, 98, 0, 72, 80, 85, 75, 80, 92, 80, 80, 82, 67, 67, 96, 75, 81, 0, 5, 90, 74, 61, 71, 88, 69, 112, 115, 102, 87, 96, 109, 89, 69, 82, 73, 90, 94, 85, 87, 97, 94, 95, 93, 76, 96, 95, 93, 92];
let deg2 = [62, 99, 76, 96, 107, 86, 106, 100, 91, 106, 89, 92, 97, 97, 93, 95, 99, 49, 95, 99, 107, 88, 110, 86, 73, 94, 80, 98, 0, 93, 90, 102, 94, 97, 88, 85, 93, 104, 79, 93, 77, 94, 88, 98, 109, 111, 98, 89, 97, 50, 83, 113, 0, 92, 85, 89, 74, 100, 100, 94, 79, 78, 106, 78, 100, 81, 69, 0, 74, 83, 91, 86, 77, 93, 95, 108, 113, 97, 103, 93, 105, 97, 98, 97, 87, 94, 105, 102, 87, 91, 112, 93, 92, 97, 98, 90, 110, 86];
...
for(let i in deg1){
    deg.push(deg1[i] + deg2[i]);
    deg_sorted.push(deg1[i] + deg2[i]);
}
...
if(parseInt(w) <= 1000){
    document.getElementById("title").innerHTML = "2nd Communications & Computer<br><br>" + "Math - Total";
}
