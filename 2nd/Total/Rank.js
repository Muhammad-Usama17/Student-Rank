let technical = [45, 42, 41, 41, 46, 48, 43, 48, 47, 44, 48, 46, 47, 40, 46, 48, 47, 30, 46, 45, 44, 47, 47, 43, 42, 47, 44, 48, 25, 41, 47, 47, 44, 46, 43, 40, 45, 44, 47, 50, 41, 45, 48, 48, 49, 49, 43, 48, 46, 39, 43, 48, 0, 45, 45, 46, 46, 49, 49, 47, 48, 47, 46, 44, 46, 44, 41, 0, 42, 49, 48, 47, 46, 46, 46, 49, 49, 47, 44, 48, 46, 42, 44, 45, 47, 48, 46, 45, 45, 48, 48, 46, 45, 43, 45, 46, 49, 43];
...
for(let i in signals){
    deg.push((measurements[i] + fundamentals[i] + co[i] + programming[i] + math1[i] + pm[i]) + (signals[i] + electronics[i] + test[i] + logic[i] + math2[i] + technical[i]));
    deg_sorted.push((measurements[i] + fundamentals[i] + co[i] + programming[i] + math1[i]) + (pm[i] + signals[i] + electronics[i] + test[i] + logic[i] + math2[i] + technical[i]));
}
...
document.getElementById("page").onload = function(){
    ...
    mobileCourseDropdownHeight1 = getComputedStyle(mobileCourseDropdownContainer1).height;
    mobileCourseDropdownContainer1.style.height = "0";

    mobileCourseDropdownHeight2 = getComputedStyle(mobileCourseDropdownContainer2).height;
...
function mobileDropdown2(){
    if(mobileCourseDropdownOpened1 == 0){
        document.getElementById("dropdown-container2").style.height = mobileCourseDropdownHeight1;
...
function mobileDropdown3(){
    if(mobileCourseDropdownOpened2 == 0){
        document.getElementById("dropdown-container3").style.height = mobileCourseDropdownHeight2;
...
function dropdown4(){
    ...
    if(dropdownOpened4 == 0){
        document.getElementById("myDropdown3").style.height = dropdownHeight3;
        dropdownOpened4 = 1;
...
function name_search(){
    ...
    if(name_to_find != ""){
        ...
        if (found == 1){
            ...
            document.getElementById("percentage1").innerHTML = ((degree / 1500) * 100).toFixed(2) + "%";
    ...
    if(name_to_find != ""){
        ...
        if (found != 0){
            ...
            for(let r of ranks_arng){
                ...
                dataP.innerHTML = ((deg[inner_index] / 1500) * 100).toFixed(2) + "%";
...
function bn_search(){
    ...
    if(index >= 0 && index < names.length){
        ...
        document.getElementById("percentage2").innerHTML = ((degree / 1500) * 100).toFixed(2) + "%";
...
function rank_search(){
    if(document.getElementById("rankin").value != ""){
        ...
        if (degree == undefined){
            ...
            document.getElementById("percentage3").innerHTML = ((degree / 1500) * 100).toFixed(2) + "%";
...
function degree_search(){    
    if(document.getElementById("degree").value != ""){
        ...
        if (rank == -1){
            ...
            document.getElementById("percentage4").innerHTML = ((deg_sorted[rank] / 1500) * 100).toFixed(2) + "%";
...
function rank_show(){
    ...
    if(initIndex >= 0 && initIndex < deg_sorted.length && finIndex >= 0 && finIndex < deg_sorted.length && finIndex - initIndex > 0){
        ...
        for(let i = 0; i < index.length; i++){
            ...
            dataP.innerHTML = ((deg[index[i]] / 1500) * 100).toFixed(2) + "%";
...
function degree_show(){
    ...
    if(initdeg >= 0 && initdeg <= 1500 && findeg >= 0 && findeg <= 1500 && findeg - initdeg != 0){
        // TO GET ALL BETWEEN THE GIVEN RANGE FROM THE USER
        let index = [];
...
function bn_show(){
    ...
    if(initIndex >= 0 && initIndex < names.length && finIndex >= 0 && finIndex < names.length && finIndex - initIndex > 0){
        ...
        for(let i = 0; i <= finIndex - initIndex; i++){
            ...
            dataP.innerHTML = ((deg[index] / 1500) * 100).toFixed(2) + "%";
