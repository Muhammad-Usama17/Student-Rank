...
let fundamentals = [73, 97, 86, 79, 103, 109, 106, 102, 111, 128, 111, 128, 131, 101, 107, 109, 105, 26, 87, 113, 112, 101, 136, 79, 78, 88, 80, 100, 0, 97, 84, 134, 119, 134, 77, 94, 112, 92, 82, 97, 81, 115, 101, 105, 145, 106, 113, 113, 110, 65, 109, 115, 0, 80, 54, 103, 54, 96, 105, 82, 89, 70, 98, 69, 117, 74, 66, 0, 37, 111, 106, 93, 91, 113, 105, 132, 143, 139, 94, 94, 104, 94, 100, 90, 75, 99, 98, 67, 82, 62, 108, 102, 94, 81, 105, 134, 120, 100];
...
for(let i in measurements){
    deg.push(measurements[i] + fundamentals[i] + co[i] + programming[i] + math[i] + pm[i]);
    deg_sorted.push(measurements[i] + fundamentals[i] + co[i] + programming[i] + math[i] + pm[i]);
}
...
function name_search(){
    ...
    if(name_to_find != ""){
        ...
        if (found == 1){
            ...
            document.getElementById("percentage1").innerHTML = ((degree / 750) * 100).toFixed(2) + "%";
    ...
    if(name_to_find != ""){
        ...
        if (found != 0){
            ...
            for(let r of ranks_arng){
                ...
                dataP.innerHTML = ((deg[inner_index] / 750) * 100).toFixed(2) + "%";
...
function bn_search(){
    ...
    if(index >= 0 && index < names.length){
        ...
        document.getElementById("percentage2").innerHTML = ((degree / 750) * 100).toFixed(2) + "%";
...
function rank_search(){
    if(document.getElementById("rankin").value != ""){
        ...
        if (degree == undefined){
            ...
            document.getElementById("percentage3").innerHTML = ((degree / 750) * 100).toFixed(2) + "%";
...
function degree_search(){    
    if(document.getElementById("degree").value != ""){
        ...
        if (rank == -1){
            ...
            document.getElementById("percentage4").innerHTML = ((deg_sorted[rank] / 750) * 100).toFixed(2) + "%";
...
function rank_show(){
    ...
    if(initIndex >= 0 && initIndex < deg_sorted.length && finIndex >= 0 && finIndex < deg_sorted.length && finIndex - initIndex > 0){
        ...
        for(let i = 0; i < index.length; i++){
            ...
            dataP.innerHTML = ((deg[index[i]] / 750) * 100).toFixed(2) + "%";
...
function degree_show(){
    ...
    if(initdeg >= 0 && initdeg <= 750 && findeg >= 0 && findeg <= 750 && findeg - initdeg != 0){
        // TO GET ALL BETWEEN THE GIVEN RANGE FROM THE USER
        let index = [];
...
function bn_show(){
    ...
    if(initIndex >= 0 && initIndex < names.length && finIndex >= 0 && finIndex < names.length && finIndex - initIndex > 0){
        ...
        for(let i = 0; i <= finIndex - initIndex; i++){
            ...
            dataP.innerHTML = ((deg[index] / 750) * 100).toFixed(2) + "%";
