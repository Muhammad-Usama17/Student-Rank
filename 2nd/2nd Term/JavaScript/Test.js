let deg = [82, 90, 85, 74, 94, 84, 88, 94, 87, 90, 84, 89, 88, 79, 92, 87, 90, 79, 83, 89, 93, 91, 95, 93, 85, 92, 91, 92, 61, 88, 95, 94, 87, 91, 81, 86, 95, 91, 91, 98, 78, 92, 93, 92, 92, 93, 90, 92, 88, 73, 82, 93, 0, 83, 81, 84, 82, 87, 87, 89, 92, 91, 87, 87, 92, 83, 82, 0, 18, 91, 92, 92, 93, 85, 93, 93, 98, 98, 89, 86, 90, 80, 92, 82, 85, 86, 97, 93, 85, 96, 93, 90, 89, 93, 89, 93, 92, 86];
let deg_sorted = [82, 90, 85, 74, 94, 84, 88, 94, 87, 90, 84, 89, 88, 79, 92, 87, 90, 79, 83, 89, 93, 91, 95, 93, 85, 92, 91, 92, 61, 88, 95, 94, 87, 91, 81, 86, 95, 91, 91, 98, 78, 92, 93, 92, 92, 93, 90, 92, 88, 73, 82, 93, 0, 83, 81, 84, 82, 87, 87, 89, 92, 91, 87, 87, 92, 83, 82, 0, 18, 91, 92, 92, 93, 85, 93, 93, 98, 98, 89, 86, 90, 80, 92, 82, 85, 86, 97, 93, 85, 96, 93, 90, 89, 93, 89, 93, 92, 86];
...
function name_search(){
    ...
    if(name_to_find != ""){
        ...
        if (found == 1){
            ...
            document.getElementById("percentage1").innerHTML = ((degree / 100) * 100).toFixed(2) + "%";
    ...
    if(name_to_find != ""){
        ...
        if (found != 0){
            ...
            for(let r of ranks_arng){
                ...
                dataP.innerHTML = ((deg[inner_index] / 100) * 100).toFixed(2) + "%";
...
function bn_search(){
    ...
    if(index >= 0 && index < names.length){
        ...
        document.getElementById("percentage2").innerHTML = ((degree / 100) * 100).toFixed(2) + "%";
...
function rank_search(){
    if(document.getElementById("rankin").value != ""){
        ...
        if (degree == undefined){
            ...
            document.getElementById("percentage3").innerHTML = ((degree / 100) * 100).toFixed(2) + "%";
...
function degree_search(){    
    if(document.getElementById("degree").value != ""){
        ...
        if (rank == -1){
            ...
            document.getElementById("percentage4").innerHTML = ((deg_sorted[rank] / 100) * 100).toFixed(2) + "%";
...
function rank_show(){
    ...
    if(initIndex >= 0 && initIndex < deg_sorted.length && finIndex >= 0 && finIndex < deg_sorted.length && finIndex - initIndex > 0){
        ...
        for(let i = 0; i < index.length; i++){
            ...
            dataP.innerHTML = ((deg[index[i]] / 100) * 100).toFixed(2) + "%";
...
function degree_show(){
    ...
    if(initdeg >= 0 && initdeg <= 100 && findeg >= 0 && findeg <= 100 && findeg - initdeg != 0){
        // TO GET ALL BETWEEN THE GIVEN RANGE FROM THE USER
        let index = [];
...
function bn_show(){
    ...
    if(initIndex >= 0 && initIndex < names.length && finIndex >= 0 && finIndex < names.length && finIndex - initIndex > 0){
        ...
        for(let i = 0; i <= finIndex - initIndex; i++){
            ...
            dataP.innerHTML = ((deg[index] / 100) * 100).toFixed(2) + "%";
