let deg = [110, 120, 135, 117, 154, 120, 109, 127, 131, 149, 119, 123, 131, 101, 123, 135, 150, 89, 127, 125, 135, 155, 162, 126, 132, 137, 136, 142, 113, 126, 114, 148, 133, 156, 117, 137, 137, 134, 127, 147, 118, 145, 129, 133, 163, 147, 144, 145, 131, 87.5, 120, 152, 0, 116, 117, 131, 134, 137, 137, 139, 119, 136, 125, 109, 146, 130, 110, 0, 0, 134, 120, 137, 118, 138, 133, 162, 159, 167, 118, 127, 135, 128, 133, 128, 143, 130, 147, 134, 118, 132, 143, 131, 110, 115, 139, 146, 132, 112];
let deg_sorted = [110, 120, 135, 117, 154, 120, 109, 127, 131, 149, 119, 123, 131, 101, 123, 135, 150, 89, 127, 125, 135, 155, 162, 126, 132, 137, 136, 142, 113, 126, 114, 148, 133, 156, 117, 137, 137, 134, 127, 147, 118, 145, 129, 133, 163, 147, 144, 145, 131, 87.5, 120, 152, 0, 116, 117, 131, 134, 137, 137, 139, 119, 136, 125, 109, 146, 130, 110, 0, 0, 134, 120, 137, 118, 138, 133, 162, 159, 167, 118, 127, 135, 128, 133, 128, 143, 130, 147, 134, 118, 132, 143, 131, 110, 115, 139, 146, 132, 112];
...
function name_search(){
    ...
    if(name_to_find != ""){
        ...
        if (found == 1){
            ...
            document.getElementById("percentage1").innerHTML = ((degree / 175) * 100).toFixed(2) + "%";
    ...
    if(name_to_find != ""){
        ...
        if (found != 0){
            ...
            for(let r of ranks_arng){
                ...
                dataP.innerHTML = ((deg[inner_index] / 175) * 100).toFixed(2) + "%";
...
function bn_search(){
    ...
    if(index >= 0 && index < names.length){
        ...
        document.getElementById("percentage2").innerHTML = ((degree / 175) * 100).toFixed(2) + "%";
...
function rank_search(){
    if(document.getElementById("rankin").value != ""){
        ...
        if (degree == undefined){
            ...
            document.getElementById("percentage3").innerHTML = ((degree / 175) * 100).toFixed(2) + "%";
...
function degree_search(){    
    if(document.getElementById("degree").value != ""){
        ...
        if (rank == -1){
            ...
            document.getElementById("percentage4").innerHTML = ((deg_sorted[rank] / 175) * 100).toFixed(2) + "%";
...
function rank_show(){
    ...
    if(initIndex >= 0 && initIndex < deg_sorted.length && finIndex >= 0 && finIndex < deg_sorted.length && finIndex - initIndex > 0){
        ...
        for(let i = 0; i < index.length; i++){
            ...
            dataP.innerHTML = ((deg[index[i]] / 175) * 100).toFixed(2) + "%";
...
function degree_show(){
    ...
    if(initdeg >= 0 && initdeg <= 175 && findeg >= 0 && findeg <= 175 && findeg - initdeg != 0){
        // TO GET ALL BETWEEN THE GIVEN RANGE FROM THE USER
        let index = [];
...
function bn_show(){
    ...
    if(initIndex >= 0 && initIndex < names.length && finIndex >= 0 && finIndex < names.length && finIndex - initIndex > 0){
        ...
        for(let i = 0; i <= finIndex - initIndex; i++){
            ...
            dataP.innerHTML = ((deg[index] / 175) * 100).toFixed(2) + "%";
