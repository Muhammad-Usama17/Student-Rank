let deg = [71, 103, 86, 77, 84, 81, 92, 75, 86, 105, 90, 77, 86, 50, 94, 81, 96, 27, 75, 89, 96, 92, 102, 70, 91, 89, 85, 104, 66, 81, 79, 106, 95, 87, 88, 83, 107, 92, 76, 89, 99, 69, 80, 93, 102, 106, 86, 97, 79, 71, 75, 98, 0, 72, 80, 85, 75, 80, 92, 80, 80, 82, 67, 67, 96, 75, 81, 0, 5, 90, 74, 61, 71, 88, 69, 112, 115, 102, 87, 96, 109, 89, 69, 82, 73, 90, 94, 85, 87, 97, 94, 95, 93, 76, 96, 95, 93, 92];
let deg_sorted = [71, 103, 86, 77, 84, 81, 92, 75, 86, 105, 90, 77, 86, 50, 94, 81, 96, 27, 75, 89, 96, 92, 102, 70, 91, 89, 85, 104, 66, 81, 79, 106, 95, 87, 88, 83, 107, 92, 76, 89, 99, 69, 80, 93, 102, 106, 86, 97, 79, 71, 75, 98, 0, 72, 80, 85, 75, 80, 92, 80, 80, 82, 67, 67, 96, 75, 81, 0, 5, 90, 74, 61, 71, 88, 69, 112, 115, 102, 87, 96, 109, 89, 69, 82, 73, 90, 94, 85, 87, 97, 94, 95, 93, 76, 96, 95, 93, 92];
...
function name_search(){
    ...
    if(name_to_find != ""){
        ...
        if (found == 1){
            ...
            document.getElementById("percentage1").innerHTML = ((degree / 125) * 100).toFixed(2) + "%";
    ...
    if(name_to_find != ""){
        ...
        if (found != 0){
            ...
            for(let r of ranks_arng){
                ...
                dataP.innerHTML = ((deg[inner_index] / 125) * 100).toFixed(2) + "%";
...
function bn_search(){
    ...
    if(index >= 0 && index < names.length){
        ...
        document.getElementById("percentage2").innerHTML = ((degree / 125) * 100).toFixed(2) + "%";
...
function rank_search(){
    if(document.getElementById("rankin").value != ""){
        ...
        if (degree == undefined){
            ...
            document.getElementById("percentage3").innerHTML = ((degree / 125) * 100).toFixed(2) + "%";
...
function degree_search(){    
    if(document.getElementById("degree").value != ""){
        ...
        if (rank == -1){
            ...
            document.getElementById("percentage4").innerHTML = ((deg_sorted[rank] / 125) * 100).toFixed(2) + "%";
...
function rank_show(){
    ...
    if(initIndex >= 0 && initIndex < deg_sorted.length && finIndex >= 0 && finIndex < deg_sorted.length && finIndex - initIndex > 0){
        ...
        for(let i = 0; i < index.length; i++){
            ...
            dataP.innerHTML = ((deg[index[i]] / 125) * 100).toFixed(2) + "%";
...
function degree_show(){
    ...
    if(initdeg >= 0 && initdeg <= 125 && findeg >= 0 && findeg <= 125 && findeg - initdeg != 0){
        // TO GET ALL BETWEEN THE GIVEN RANGE FROM THE USER
        let index = [];
...
function bn_show(){
    ...
    if(initIndex >= 0 && initIndex < names.length && finIndex >= 0 && finIndex < names.length && finIndex - initIndex > 0){
        ...
        for(let i = 0; i <= finIndex - initIndex; i++){
            ...
            dataP.innerHTML = ((deg[index] / 125) * 100).toFixed(2) + "%";
