...
let math = [71, 103, 86, 77, 84, 81, 92, 75, 86, 105, 90, 77, 86, 50, 94, 81, 96, 27, 75, 89, 96, 92, 102, 70, 91, 89, 85, 104, 66, 81, 79, 106, 95, 87, 88, 83, 107, 92, 76, 89, 99, 69, 80, 93, 102, 106, 86, 97, 79, 71, 75, 98, 0, 72, 80, 85, 75, 80, 92, 80, 80, 82, 67, 67, 96, 75, 81, 0, 5, 90, 74, 61, 71, 88, 69, 112, 115, 102, 87, 96, 109, 89, 69, 82, 73, 90, 94, 85, 87, 97, 94, 95, 93, 76, 96, 95, 93, 92];
...
for(let i in signals){
    deg.push(signals[i] + electronics[i] + test[i] + logic[i] + math[i] + technical[i]);
    deg_sorted.push(signals[i] + electronics[i] + test[i] + logic[i] + math[i] + technical[i]);
}
