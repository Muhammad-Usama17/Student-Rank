...
for(let i in electronics){
    deg.push(electronics[i] + circuits2[i] + test[i] + applications[i] + math2[i] + english[i]);
    deg_sorted.push(electronics[i] + circuits2[i] + test[i] + applications[i] + math2[i] + english[i]);
}
