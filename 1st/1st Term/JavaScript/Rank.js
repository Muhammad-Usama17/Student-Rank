...
for(let i in fundamentals){
    deg.push(fundamentals[i] + circuits1[i] + programming[i] + civil[i] + math1[i] + legislations[i]);
    deg_sorted.push(fundamentals[i] + circuits1[i] + programming[i] + civil[i] + math1[i] + legislations[i]);
}
